...
public class Personal_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        price_text.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
        mid_text = (TextView)findViewById(R.id.p_add_id);
        mname_text = (TextView)findViewById(R.id.p_add_name);
        mname_text.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
        ...
        mname_text2.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
        mname_eng_text = (TextView)findViewById(R.id.p_add_text_menu_eng);
        mname_eng_text.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));

        item  = getResources().getStringArray(R.array.spinnerArray);
        ...
        /*arrayAdapter = new ArrayAdapter<>(getApplicationContext(),
                ...
                arrayList);
        */
        arrayAdapter= new ArrayAdapter<String>(getBaseContext(),R.layout.spinner_item,item);
    ...
    public class Personal_addTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                mname_eng_text.setText(jsonObject.getString("menu_name_eng"));
                ...
                ImageView imageView = (ImageView)findViewById(R.id.p_add_menu);
