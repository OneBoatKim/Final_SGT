...
public class Personal_list extends AppCompatActivity {
    ...
    {
        Intent intent = new Intent(Personal_list.this, Tumbler_main.class);
        startActivity(intent);
        finish();
    }
    ...
    public class RowDataViewHolder {
        ...
        public TextView menu_name_engHolder;
...
// TODO Auto-generated method stub
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                viewHolder.menu_name_engHolder = (TextView)convertView.findViewById(R.id.p_menu_name_eng);
            ...
            if(p_arr.get(position).shot.equals("0")){

            }else{
                personal_op += "샷 " + p_arr.get(position).shot;
            }

            if(p_arr.get(position).syrup.equals("0")){

            }else{
                if(p_arr.get(position).shot.equals("0")){
                    personal_op += "시럽 " + p_arr.get(position).syrup;
                }else{
                    personal_op += ", 시럽 " + p_arr.get(position).syrup;
                }
            }
            ...
            if(p_arr.get(position).whipped_cream == "false"){
                ...
                if(p_arr.get(position).shot.equals("0") && p_arr.get(position).syrup.equals("0")){
                    personal_op += "휘핑크림";
                }else{
                    personal_op += ", 휘핑크림";
                }
            ...
            if(p_arr.get(position).drizzle == "false"){
                ...
                if(p_arr.get(position).shot.equals("0") && p_arr.get(position).syrup.equals("0") && p_arr.get(position).whipped_cream == "false"){
                    personal_op += "드리즐";
                }else{
                    personal_op += ", 드리즐";
                }
            ...
            viewHolder.cupHolder.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
            viewHolder.shotHolder.setText(personal_op);
            viewHolder.shotHolder.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
            viewHolder.priceHolder.setText(total_price_str);
            viewHolder.priceHolder.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
            viewHolder.menu_nameHolder.setText(p_arr.get(position).menu_name);
            viewHolder.menu_nameHolder.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
            viewHolder.menu_name_engHolder.setText(p_arr.get(position).menu_name_eng);
            viewHolder.menu_name_engHolder.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
