...
public class Tumbler_addmoney extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        constraintLayout = (ConstraintLayout)findViewById(R.id.layout_addmoney);
        ...
        txt_tmoney_name.setTypeface(Typeface.createFromAsset(getAssets(),"RIXGOL.TTF"));
    ...
    public void click_1won(View v) {
        ...
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_1);
    }
    public void click_3won(View v) {
        tmoney_charge = 30000;
        tmoney_after = tmoney_now + tmoney_charge;
        txt_tmoney_after.setText(String.valueOf(tmoney_after) + "원");
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_2);
    }
    public void click_5won(View v) {
        tmoney_charge = 50000;
        tmoney_after = tmoney_now + tmoney_charge;
        txt_tmoney_after.setText(String.valueOf(tmoney_after) + "원");
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_3);
    }
    public void click_7won(View v) {
        tmoney_charge = 70000;
        tmoney_after = tmoney_now + tmoney_charge;
        txt_tmoney_after.setText(String.valueOf(tmoney_after) + "원");
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_4);
    }
    public void click_10won(View v) {
        tmoney_charge = 100000;
        tmoney_after = tmoney_now + tmoney_charge;
        txt_tmoney_after.setText(String.valueOf(tmoney_after) + "원");
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_5);
    }
    public void click_20won(View v) {
        tmoney_charge = 150000;
        tmoney_after = tmoney_now + tmoney_charge;
        txt_tmoney_after.setText(String.valueOf(tmoney_after) + "원");
        constraintLayout.setBackgroundResource(R.mipmap.tumbler_addmoney_bg_6);
    }
